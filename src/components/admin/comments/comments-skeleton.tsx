...
import { CommentsCardSkeleton } from "@/components/admin/comments/comments-card-skeleton";
import { Table, TableHeader, TableHead, TableRow, TableBody, TableCell, TableCaption } from "@/components/ui/table";


export function CommentsSkeleton({ rows }: { rows: number }) {
    ...
    return (
        <div className="space-y-4">
            ...
            <ul className="flex flex-col gap-5 lg:hidden">
                {array.map((_, index) => <CommentsCardSkeleton key={index} />)}
            </ul>
