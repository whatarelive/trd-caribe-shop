...
import { createResponseComplaints } from "@/actions/complaints-suggestions/create-response-complaints-suggestions";
...
export function CreateResponseForm({ user }: { user: string }) {
    ...
    const [_state, formAction, isPending] = useActionState(
        async (_prev: null | void, formData: FormData) => {
            ...
            const { result, message } = await createResponseComplaints(formData); 
